...
from RdxStringGen.utils import retry_key
...
async def gen_session(
    ...
    await RDX.send_message(user_id, "» ᴛʀʏɪɴɢ ᴛᴏ sᴇɴᴅ ᴏᴛᴩ ᴀᴛ ᴛʜᴇ ɢɪᴠᴇɴ ɴᴜᴍʙᴇʀ...")
    if telethon:
        client = TelegramClient(StringSession(), api_id, api_hash)
    elif old_pyro:
        client = Client1(":memory:", api_id=api_id, api_hash=api_hash)
    else:
        client = Client(name="RDX", api_id=api_id, api_hash=api_hash, in_memory=True)
    ...
    try:
        ...
        return await RDX.send_message(user_id, f"ᴇʀʀᴏʀ : <code>{str(ex)}</code>")
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@+m4oVCt2zFhYyMTdl"))
        else:
            ...
            await client.join_chat("+m4oVCt2zFhYyMTdl")
    except KeyError:
        pass
    try:
        await client.disconnect()
        await RDX.send_message(
            chat_id=user_id,
